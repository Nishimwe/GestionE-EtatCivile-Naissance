...
const FormCreateUsers = ({ closeModal }) => {
    ...
    const Envoyer = async() => {
        ...
        if(nom && prenom && username && idrole && password && confirmepassword){
    ...
    return (
        ...
        <div className=" z-10 fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 ">
            <div className="bg-white rounded-lg shadow-lg p-6 w-96 text-black w-[50rem] h-[98%]">
                    ...
                    <div className="grid gap-4 mb-4 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            >
                                ...
                                {reles && reles.map((role) => (
                                    <option key={role.idrole} value={role.idrole}>{role.nomrole}</option>
                                ))}
                            </select>
                        </div>
                        <div>
                        ...
                        <div>
                            <label
                                ...
                                className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                            >
                                <span className="text-red-500">*</span>Commune
                            </label>
                            <select
                                id="commune"
                                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
